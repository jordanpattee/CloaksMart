...
def combine_listed_and_unlisted_items(df):
    ...
    df2 = pd.read_csv('CloaksTraitTablewithRankingNumTraits.csv', keep_default_na=False)
...
def getListings():
    ...
    overall_avg_df = pd.read_csv('CloaksTraitTableWithAVGStatsOverallRanking.csv', keep_default_na=False)                         
